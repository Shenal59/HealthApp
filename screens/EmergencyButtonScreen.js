...
function EmergencyButtonScreen() {
    ...
    useEffect(() => {     
        ...
        const database_profile = firebase
            .app()
            .database('https://health-application-6cba3-default-rtdb.asia-southeast1.firebasedatabase.app')
    ...
    // Initialize Geocoder
    Geocoder.init("AIzaSyCjHqeFx6lc93GIjGjv5hmH--WGyKI1QVc");    // fill in the google api key
    ...
    const sendSMSHandler = () => {
        var phoneNumbers = ["+6590229714"];        // phone number of the emergency help center
